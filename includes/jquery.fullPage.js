...
var plusToplocation = "5%";
var minusToplocation = "-5%";
...
(function($) {
	$.fn.fullpage = function(options) {
		...
		function addTableClass(element){
			...
			$(this).find('.woman').css('height', getTableHeight(element) + 'px');
			$(this).find('.man').css('height', getTableHeight(element) + 'px');
			$(document).find('.opacity-background').css('height', getTableHeight($(this)) + 'px');
		}
